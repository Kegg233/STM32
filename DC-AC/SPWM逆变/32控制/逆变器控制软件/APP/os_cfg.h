...
#define OS_TASK_STAT_STK_SIZE   150u   /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   150u   /* Idle       task stack size (# of OS_STK wide entries)        */
